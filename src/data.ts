...
export const SKILL_WALL: SkillWallModule[] = [
  {
    ...
    color: "#ffe45e",
    tags: [
      { text: "用户行为分析", color: "#ffe45e" },
      { text: "业务数据洞察", color: "#ffe45e" },
      { text: "痛点抽象", color: "#ffe45e" },
      { text: "产品 0→1", color: "#ffe45e" },
      { text: "GMV +12%", color: "#ffe45e" },
      { text: "决策链路优化", color: "#ffe45e" },
    ],
  },
  {
    id: "vibe",
    ...
    color: "#9df2ff",
    tags: [
      { text: "Claude Code", color: "#9df2ff" },
      { text: "Codex", color: "#9df2ff" },
      { text: "Qoder CN", color: "#9df2ff" },
      { text: "WorkBuddy", color: "#9df2ff" },
      { text: "Coze", color: "#9df2ff" },
      { text: "Figma", color: "#9df2ff" },
    ],
  },
  {
    id: "tech",
    ...
    color: "#b6ff9d",
    tags: [
      { text: "Agent", color: "#b6ff9d" },
      { text: "RAG", color: "#b6ff9d" },
      { text: "Memory", color: "#b6ff9d" },
      { text: "Harness", color: "#b6ff9d" },
      { text: "Python", color: "#b6ff9d" },
      { text: "SQL", color: "#b6ff9d" },
      { text: "上下文管理", color: "#b6ff9d" },
      { text: "Tool 调用 · SCI × 5", color: "#b6ff9d" },
    ],
  },
];
